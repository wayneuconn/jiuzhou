...
exports.main = async (event, context) => {
  ...
  const collections = ['users', 'matches', 'registrations', 'announcements', 'payments', 'paymentEvents', 'inviteTokens', 'config', 'formations', 'membershipApplications', 'events', 'eventRegistrations']
